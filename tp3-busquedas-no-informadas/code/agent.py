...
class Agent:
    ...
    def get_action_cost(self, action): # Saca los costos segun el escenario
        if self.scenario == 1:
            return 1
    ...
    def bfs(self, initial_state, goal_state, size, desc):
        ...
        frontier.put((initial_state, [])) #Inicializar la queue con el estado inicial
        explored = set()
    ...
    def uniformCost_search(self, initial_state, goal_state, size, desc):
